 ...
 */
function nestor_form_user_register_form_alter(&$form, &$form_state, $form_id) {
	//echo "<pre>"; print_r($form_id); die;
    $form['#attributes'] = array('class' => 'login_outer');
   ...
   $form['account']['pass'] = array(
    ...
    $form['account']['pass']['#prefix'] = '<div class="hishow"><a href="javascript:void(0);" class="show_toggle">show</a>';
    $form['account']['pass']['#suffix'] = '</div>';
    $form['actions']['submit']['#value'] = t('Start my free trial');
    $form['actions']['submit']['#attributes']['class'][] = 'primary_box_btn';
}

function nestor_form_user_login_alter(&$form, &$form_state, $form_id) {
    $form['#attributes'] = array('class' => 'login_outer');
    $form['name'] = array(
        '#type' => 'textfield',
        '#title' => t(''),
...
function nestor_form_user_pass_alter(&$form, &$form_state, $form_id) {
    $form['#attributes'] = array('class' => 'login_outer');
    $form['name'] = array(
        '#type' => 'textfield',
        '#title' => t(''),
